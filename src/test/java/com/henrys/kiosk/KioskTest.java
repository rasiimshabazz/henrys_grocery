...
public class KioskTest {
    ...
    void test_takeShoppersOrder() {
        ...
        assertEquals(new Basket(bread, LocalDate.now(), null).toString(), kiosk.takeShoppersOrder().toString());
    ...
    void test_takeShoppersOrder_1_soup_with_blank_entries() {
        ...
        assertEquals(new Basket(expectedProducts, LocalDate.now(), null).toString(), kiosk.takeShoppersOrder().toString());
