...
class BasketTest {
    ...
    void test_priceBasket_multiple() {
        ...
        Assertions.assertEquals(format(4.55), basket.calculatePrice(new ArrayList<>()));
    }
    ...
    void test_priceBasket_multiple_combo() {
        ...
        Assertions.assertEquals(format(3.55), basket.calculatePrice(new ArrayList<>()));
    }
    ...
    void test_priceBasket_multiple_no_promo_soup_bread_variation() {
        ...
        Assertions.assertEquals(format(2.10), basket.calculatePrice(new ArrayList<>()));
    }
    ...
    void test_priceBasket_apples_milk_no_coupon() {
        ...
        Assertions.assertEquals(format(1.90), basket.calculatePrice(new ArrayList<>()));
    }
