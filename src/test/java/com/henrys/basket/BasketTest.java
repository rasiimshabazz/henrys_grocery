...
public class BasketTest {
    ...
    void test_calculatePrice_bread_coupon_rolled_up() {
        ...
        Assertions.assertEquals(format(3.15), basket.calculatePrice(Collections.singletonList(
                new Coupon(LocalDate.now().minusDays(1), LocalDate.now().minusDays(1).plusDays(7), Coupon.COUPON_IND_BREAD)), LocalDate.now()));
    }
    ...
    void test_calculatePrice_bread_coupon_rolled_up_negative() {
        ...
        Assertions.assertEquals(format(0.00), basket.calculatePrice(null, null));
    }
    ...
    void test_calculatePrice_apple_coupon_invalid() {
        ...
        Assertions.assertEquals(format(1.90), basket.calculatePrice(null, null));
    }
    ...
    void test_calculatePrice_apple_coupon_valid() {
        ...
        Assertions.assertEquals(format(1.84), basket.calculatePrice(Arrays.asList(
                ...
                new Coupon(LocalDate.now().plusDays(3), LocalDate.now().plusDays(3).plusMonths(1).with(TemporalAdjusters.lastDayOfMonth()), Coupon.COUPON_IND_APPLE)), boughtInFiveDaysTime));
    }
    ...
    void test_calculatePrice_multiple_before_coupon() {
        ...
        Assertions.assertEquals(format(3.55), basket.calculatePrice(null, null));
    }
    ...
    void test_calculatePrice_of_null() {
        ...
        Assertions.assertEquals(format(0),
                new Basket(null, null).calculatePrice(null, null));
    }
    ...
    void test_calculatePrice_of_nada() {
        ...
        Assertions.assertEquals(format(0),
                new Basket(new ArrayList<>(), LocalDate.now()).calculatePrice(null, null));
    }
    ...
    void test_calculatePrice_soup_no_coupons() {
        ...
        Assertions.assertEquals(format(0.65), basket.calculatePrice(null, null));
    }
    ...
    void test_calculatePrice_multiple_merged_with_bread() {
        ...
        Assertions.assertEquals(format(5.35), basket.calculatePrice(null, null));
    }
