...
public class BasketTest {
    ...
    void test_calculatePrice_bread_coupon_rolled_up_negative() {
        ...
        Assertions.assertEquals(format(0.00), basket.calculatePrice(null));
    }
    ...
    void test_calculatePrice_apple_coupon_invalid() {
        ...
        Assertions.assertEquals(format(1.90), basket.calculatePrice(null));
    }
    ...
    void test_calculatePrice_multiple_before_coupon() {
        ...
        Assertions.assertEquals(format(3.55), basket.calculatePrice(null));
    }
    ...
    void test_calculatePrice_of_null() {
        ...
        Assertions.assertEquals(format(0),
                new Basket(null, null).calculatePrice(null));
    }
    ...
    void test_calculatePrice_of_nada() {
        ...
        Assertions.assertEquals(format(0),
                new Basket(new ArrayList<>(), LocalDate.now()).calculatePrice(null));
    }
